...
const UI = ({ ACData, InventoryData, View, HomeData, AccessControls, WeatherData, loadACRequest, setView, loadData }) => {
                                            ...
                                            ( val, index ) => {
                                                return (
                                                    <tr key={index} className='pointer pointer-hover' onClick={ () => openACDetails( val.id ) }>
                                                        ...
                                                        <td>{ new Date(val.last_updated).toDateString() }</td>
                                                    </tr>
                                                )
                                            }
                                        )
                ...
                <tbody>
                    {
                        Requests.map(
                            ( val, index ) => {
                                const recorded_date = val.recorded_date ? new Date(val.recorded_date).toDateString() : null;
                                return (
