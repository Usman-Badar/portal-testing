                                ...
                                <div className="Upper RequestInfo">
                                    ...
                                    <div className="Right RequestInfo">
                                        ...
                                        <div className="TableDiv">
                                            ...
                                            {/* VALUE */}
                                            <div className='divs d-flex align-items-center justify-content-between'>

                                                { 
                                                    val.pr_code === null || val.pr_code === 0 || val.pr_code === undefined 
                                                    ? 
                                                    ...
                                                    <>
                                                        ...
                                                        <i 
                                                            ...
                                                            onClick={ () => props.ShowModal( val.pr_id ) }
                                                        ></i>
                                                    </>
                                                }
