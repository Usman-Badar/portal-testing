            ...
            <div className='ViewTempEmployee d-center'>
                <div className="ViewTempEmployee-content">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <Link to="/employment_setup/requests" className="text-dark"><i className="las la-arrow-left"></i> Go Back</Link>
                        {

                            Status === 'Waiting For Approval'
                            ?
                            <Link to={ "/employment_setup/requests/confirm/" + window.location.href.split('/').pop() } className="btn btn-sm btn-info">Confirm Approval</Link>
                            :
                            null
