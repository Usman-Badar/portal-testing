...
const Report2 = () => {
    ...
    useEffect(
        () => {
            ...
            if (StartDate.length > 0 && EndDate.length > 0) fetchUsersNotCollectedRashan( StartDate, EndDate, setUsers);
            ...
            <div className="page-content">
                <div className="d-flex align-items-center justify-content-between">
                    <h3 className="heading">
                        ...
                        <sub>Users who did not collected the rashan during the period</sub>
                    </h3>
                                ...
                                users.filter(
                                    ...
                                    return (
                                        <tr key={val.registration_id} className='pointer pointer-hover'>
                                            ...
                                            <td>{val?.tbl_pf_rd_category?.category_id === 1 && val?.company_name}</td>
                                            <td>{val?.tbl_pf_rd_category?.category_id === 1 && val?.location_name}</td>
                                            <td>{val?.last_delivery_date ? <span className='text-success'>{moment(val?.last_delivery_date).format('YYYY-MM-DD')}</span> : <span className='text-danger'>No Delivery Found</span>}</td>
                                        </tr>
                                    )
                                })
                            }
